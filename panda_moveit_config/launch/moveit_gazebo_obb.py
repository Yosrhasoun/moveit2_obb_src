...
def generate_launch_description():
    ...
    # Bridge (IMPORTANT: set use_sim_time)
    bridge = Node(
    ...
    # IMPORTANT: delay controller spawning so /clock is available
    delayed_controllers = TimerAction(period=3.0, actions=load_controllers)
